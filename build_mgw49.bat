...
cd stage64\lib
echo create libboost-mgw94-64-s.a >> all.mri
for %%f in (libboost_*.a) do (echo addlib %%f >> all.mri)
echo save >> all.mri
echo end >> all.mri
ar -M < all.mri
del /Q all.mri
move libboost-mgw94-64-s.a ..\..\stage\lib\
cd ..\..
...
cd stage32\lib
echo create libboost-mgw94-32-s.a >> all.mri
for %%f in (libboost_*.a) do (echo addlib %%f >> all.mri)
echo save >> all.mri
echo end >> all.mri
ar -M < all.mri
del /Q all.mri
move libboost-mgw94-32-s.a ..\..\stage\lib\
cd ..\..
...
echo create libboost-mgw94-64-sd.a >> all.mri
for %%f in (libboost_*.a) do (echo addlib %%f >> all.mri)
echo save >> all.mri
echo end >> all.mri
ar -M < all.mri
del /Q all.mri
move libboost-mgw94-64-sd.a ..\..\stage\lib\
cd ..\..
...
echo create libboost-mgw94-32-sd.a >> all.mri
for %%f in (libboost_*.a) do (echo addlib %%f >> all.mri)
echo save >> all.mri
echo end >> all.mri
ar -M < all.mri
del /Q all.mri
move libboost-mgw94-32-sd.a ..\..\stage\lib\
cd ..\..